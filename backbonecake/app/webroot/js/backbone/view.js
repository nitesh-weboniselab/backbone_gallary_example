...
//                                    self.$el.html(self.addPhotoTemplate);
        ...
        listAlbumView:Backbone.View.extend({
            ...
            render:function () {
                this.listAlbumCollection = new Album.Gallary.collection.listAlbumCollection(this.listAlbumModel.get('albumList'));
        ...
        listPhotoView:Backbone.View.extend({
            ...
            render:function(){
                this.listPhotoCollection = new Album.Gallary.collection.listPhotoCollection(this.listPhotoModel.get('photoList'));
